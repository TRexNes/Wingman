...
class ActiveController: WingmanBaseController {
    ...
    var questionStory : ActiveStory?
    var question : ActivePage?
...
*****************************************/
        ...
        if questionStory == nil {
            self.questionStory = ActiveStory.favoriteOverlook
        }
        
        self.question = ActivePage(story: self.questionStory!)
        ...
        let choiceActionArray = questionDetailsDict.value(forKey: QuestionKey.choiceActions.rawValue) as! [ActiveStory]
    ...
    func navigation(_ nextStory: ActiveStory) {
        
        if nextStory == ActiveStory.home {
            ...
            let activeController = mainStoryBoard.instantiateViewController(withIdentifier: "ActiveController") as! ActiveController
            activeController.questionStory = nextStory
            self.navigationController?.pushViewController(activeController, animated: true)
        }
    }
